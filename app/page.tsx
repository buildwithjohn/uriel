...
const SERVICES = [
  { num: "I", title: "Brand Identity Design", body: "I combine design skills and market research to create the best identity for companies and startups — appealing, functional, and built to attract sales and put you ahead of competitors." },
  { num: "II", title: "Logo Design", body: "Minimalist, timeless marks that connect with your target audience. Every logo tells a unique story and leaves a lasting impression beyond the first glance." },
  ...
  { num: "IV", title: "Social Media Visuals", body: "Scroll-stopping content that maintains brand consistency across every platform. Proven to improve engagement, recall, and the overall perception of your brand." },
    ...
    <main style={{ fontFamily: "'Jost', 'Helvetica Neue', sans-serif", background: "#F0EBE1", color: "#2C1F0E", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-u { font-family:'Italiana',serif; font-size:20px; color:#2C1F0E; letter-spacing:0.04em; line-height:1; }
      ...
      <nav className={`u-nav${scrolled ? " scrolled" : ""}`}>
        <div className="logo-mark" onClick={() => nav("hero")}>
          <span className="logo-u">Visuals by Uriel</span>
          <span className="logo-sub">Brand · Design · Identity</span>
        </div>
        ...
        <a href="https://wa.me/2347068246856" target="_blank" rel="noreferrer" className="nav-cta">Hire Me</a>
      ...
      <section id="hero" ref={heroRef} className="hero" style={{ opacity: heroOpacity }}>
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button className="btn-ghost" onClick={() => nav("work")}>View Portfolio</button>
            <a href="https://www.behance.net/uriel01" target="_blank" rel="noreferrer" className="btn-solid">Behance Portfolio</a>
          </div>
        </div>
        ...
        <div className="about-wrap">
          <Reveal>
            <div className="about-left" style={{ minHeight: 600 }}>
              ...
              <span className="about-caption">Uriel Maforikan · Osun, Nigeria</span>
            </div>
          </Reveal>
        ...
        <div className="contact-grid">
          <Reveal>
            ...
            <div className="contact-links">
              ...
              <a href="https://wa.me/2347068246856" target="_blank" rel="noreferrer" className="contact-link">WhatsApp · 07068246856</a>
              <a href="https://www.instagram.com/vburielmaforikan" target="_blank" rel="noreferrer" className="contact-link">Instagram @vburielmaforikan</a>
              <a href="https://www.behance.net/uriel01" target="_blank" rel="noreferrer" className="contact-link">Behance · uriel01</a>
            </div>
          </Reveal>
          <Reveal delay={0.2}>
            {!sent ? (
      ...
      <footer className="footer">
        <div className="footer-top">
          <div>
            <div className="footer-logo-name">Visuals by Uriel</div>
            <div className="footer-logo-sub">Brand · Design · Identity</div>
          </div>
